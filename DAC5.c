...
// Output: none
void DAC5_Init(void){
    IOMUX->SECCFG.PINCM[PB0INDEX] = 0x00000081; //DAC bit 0
        IOMUX->SECCFG.PINCM[PB1INDEX] = 0x00000081; //DAC bit 1
        IOMUX->SECCFG.PINCM[PB2INDEX] = 0x00000081; //DAC bit 2
        IOMUX->SECCFG.PINCM[PB3INDEX] = 0x00000081; //DAC bit 3
        IOMUX->SECCFG.PINCM[PB4INDEX] = 0x00000081; //DAC bit 4
