...
// Output: none
void Key_Init(void){
    IOMUX->SECCFG.PINCM[PB16INDEX] = 0x00040081; //AF0 Key Switch
       IOMUX->SECCFG.PINCM[PB17INDEX] = 0x00040081; //GFO Key Switch
       IOMUX->SECCFG.PINCM[PB18INDEX] = 0x00040081; //EF0 Key Switch
       IOMUX->SECCFG.PINCM[PB19INDEX] = 0x00040081; //B7 Key Switch
...
uint32_t Key_In(void){
    uint32_t data = GPIOB->DIN31_0 &0x000F0000 ;
     data = (data>>16);
     return data;
}
